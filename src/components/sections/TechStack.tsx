...
const AI_TOOLS = [
  ...
  },
  {
    ...
    desc: "Industry-standard containerization platform for building, sharing, and running distributed applications seamlessly across environments.",
  ...
  },
  {
    ...
    desc: "Fair-code workflow automation tool allowing you to build complex multi-step pipelines and integrate various APIs seamlessly.",
    logo: "/logos/n8n.svg",
    color: "#FF6D5A",
    bg: "rgba(255,109,90,0.06)",
    border: "rgba(255,109,90,0.18)",
    row: 0,
  },
  {
    id: "vercel",
    ...
    desc: "Frontend cloud platform providing seamless deployment, edge functions, and high-performance infrastructure for Next.js applications.",
  ...
  },
  {
    ...
    desc: "Open-source Firebase alternative featuring a Postgres database, authentication, instant APIs, edge functions, and real-time subscriptions.",
  ...
  },
  {
    ...
    desc: "Utility-first CSS framework for rapidly building modern, highly customizable user interfaces without leaving your HTML.",
  ...
  },
  {
    ...
    desc: "The React Framework for the Web, providing hybrid static & server rendering, smart bundling, and route pre-fetching.",
  ...
  },
  {
    ...
    desc: "A comprehensive payments solution enabling seamless, secure, and fully automated financial transactions and subscriptions.",
    logo: "/logos/razorpay.svg",
    color: "#02042B",
    bg: "rgba(2,4,43,0.06)",
    border: "rgba(2,4,43,0.18)",
    row: 1,
  },
];
